...
- [x] **test71** — Fix ALL-CAPS button labels (Material) — **PR #96** — base `vibemis-main` — ☑ **PASS** (report: `testing/test71-fix-button-caps/report.md`, PR #119)  *(launcher only; user-reported UI bug)*
