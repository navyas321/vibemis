...
- [x] **test64** — Motion-control (gyro) capability detection (P3.16) — **PR #84** — base `vibemis-main` — ☑ **PASS (Tier 1)** (report: `testing/test64-motion-capability/report.md`, PR #TBD)  *(Tier 1 launcher-only; Tier 2 needs a controller)*
