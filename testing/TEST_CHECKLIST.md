...
- [x] **test54** — `selftest --json` + settings round-trip checks — **PR #74** — base `test52` — ☑ PASS ([report](test54-selftest-json/report.md))  *(launcher-only / headless; verify after test52)*
