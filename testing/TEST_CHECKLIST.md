...
- [x] **test56** — Help & Links section in Settings (GitHub / README / Tailscale) — **PR #76** — base `vibemis-main` — ☑ **PASS** (report PR #122; all 3 buttons render — "Vibemis on GitHub", "Install guide (README)", "Remote play over Tailscale — setup" — pixel-confirmed via column scan; hasBrowser gate fires, xdg-open present; Tier 2 click-through N/A due to screen-capture failure after first shot) → merged
