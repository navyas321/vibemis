...
//
// The two-gate model is the approved, permanent design. A manual checkbox —
// rather than auto-detecting panel HDR capability — is deliberate: there is no
// reliable client-side panel-capability query in the SDL2/Qt6 stack this app uses
// (Qt6 QScreen exposes none; SDL2 exposes none; SDL3's
// SDL_PROP_DISPLAY_HDR_ENABLED_BOOLEAN is documented informational/diagnostic-only
// and reports compositor HDR-enabled state, not panel capability — unreliable
// exactly on the SteamOS/gamescope + SDR-LCD case above).
