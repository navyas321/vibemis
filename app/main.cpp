...
int main(int argc, char *argv[])
{
...
#endif
    {
        s_LoggerFile = new QFile(tempDir.filePath(QString("Vibemis-%1.log").arg(QDateTime::currentSecsSinceEpoch())));
    ...
    QStringList existingLogNames = tempDir.entryList(QStringList("Vibemis-*.log"), QDir::NoFilter, QDir::SortFlag::Time);
