...
- **Upstream moonlight-qt sync** — merged with `moonlight-stream/moonlight-qt:master` (May 2026), bringing in nine months of upstream fixes while preserving all Artemis Qt Apollo extensions
...
- **[Apollo](https://github.com/ClassicOldSong/Apollo)** and **[Artemis Android](https://github.com/ClassicOldSong/moonlight-android)** by [ClassicOldSong](https://github.com/ClassicOldSong) — the Sunshine fork and Android client whose protocol extensions Vibemis speaks.
