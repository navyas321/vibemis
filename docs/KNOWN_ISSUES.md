...
| Feature | Status |
|---|---|
| **Microphone passthrough** | Client capture, negotiated Opus microphone protocol support, device selection, and live input preview are implemented in BL-2629. The client degrades cleanly when a stock host does not advertise microphone support. Host receipt remains an open validation gate in BL-2634 and requires a mic-enabled Apollo/Vibepollo host. |
